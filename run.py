...
my_net = network("Resourses\init_network.yaml")
...
q_learning = "q_learn1.csv"
q_learn_with_p = "ql_lof1.csv"
leach = "leach1.csv"
beemh = "beemh1.csv"
kmeans = "kmeans1.csv"
nmleach = "nmleach1.csv"
ql_eebdg = "ql_eebdg1.csv"
dt = "dt1.csv"
ql_with_xgb = "ql_with_xgb.csv"

fields = ['Throughput','Net_Life','Net_Energy','Latency','Energy_Balance']
with open(ql_with_xgb,'w') as csvfile:
    csvwriter = csv.writer(csvfile)
    csvwriter.writerow(fields)
    csvwriter.writerows(Measurement_data)

print(prediction_results)
accuracy,precision,recall, f1_score = Measurement_models.prediction_models(prediction_results)
print(accuracy)
